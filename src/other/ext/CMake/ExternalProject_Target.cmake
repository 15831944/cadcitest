...
if(\"\${FTYPE}\" STREQUAL \"EXEC\" OR \"\${FTYPE}\" STREQUAL \"SHARED\")
  if(APPLE)
    ...
    execute_process(COMMAND otool -l \"\${DDIR}/\${DNAME}\" RESULT_VARIABLE ORET OUTPUT_VARIABLE OTOOL_OUT)
    message(\"\n\n\"\${DDIR}/\${DNAME}\" OTOOL_OUT: ${OTOOL_OUT}\n\")
    if (NOT ORET)
      if (NOT \"\${OTOOL_OUT}\" MATCHES \"LC_RPATH\")
	execute_process(COMMAND install_name_tool -add_rpath \"\${CMAKE_BUILD_RPATH}\" \"\${DDIR}/\${DNAME}\")
	execute_process(COMMAND otool -l \"\${DDIR}/\${DNAME}\" OUTPUT_VARIABLE OTOOL_OUT2)
