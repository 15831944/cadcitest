...
function(ExternalProject_Target etype etarg extproj extroot fname)
  ...
  if ("${etype}" STREQUAL "EXEC")
    ...
    # it for CMake and there is a Mac tool that can add it for us.
    if (APPLE)
      execute_process(COMMAND otool -l ${extroot}/${BIN_DIR}/${fname} OUTPUT_VARIABLE OTOOL_OUT)
      message("\n\n${CMAKE_BINARY_ROOT}/${SHARED_DIR}/${fname} OTOOL_OUT: ${OTOOL_OUT}\n")
      if (OTOOL_OUT)
	if (NOT "${OTOOL_OUT}" MATCHES "LC_RPATH")
	  execute_process(COMMAND install_name_tool -add_rpath "${CMAKE_BUILD_RPATH}" ${extroot}/${BIN_DIR}/${fname})
	  execute_process(COMMAND otool -l ${extroot}/${BIN_DIR}/${fname} OUTPUT_VARIABLE OTOOL_OUT2)
	  message("OTOOL_OUT2: ${OTOOL_OUT2}")
	endif (NOT "${OTOOL_OUT}" MATCHES "LC_RPATH")
      endif (OTOOL_OUT)
    endif (APPLE)
