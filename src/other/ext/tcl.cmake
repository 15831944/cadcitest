...
if (BRLCAD_TCL_BUILD)
  ...
  if (NOT MSVC)
    ...
    ExternalProject_Add(TCL_BLD
      ...
      BUILD_COMMAND ${VCVARS_BAT} & exit 0 && nmake -f makefile.vc INSTALLDIR=${TCL_INSTDIR} SUFX=
      INSTALL_COMMAND ${VCVARS_BAT} & exit 0 && nmake -f makefile.vc install INSTALLDIR=${TCL_INSTDIR} SUFX=
      )
    set(TCL_APPINIT)
