...
extern STEPCODE_EXPRESS_EXPORT int yylineno;
...
STEPCODE_EXPRESS_EXPORT void    _MEMinitialize PROTO( ( void ) );
STEPCODE_EXPRESS_EXPORT void    MEMinitialize PROTO( ( struct freelist_head *, int, int, int ) );
STEPCODE_EXPRESS_EXPORT void    MEM_destroy PROTO( ( struct freelist_head *, Freelist * ) );
STEPCODE_EXPRESS_EXPORT Generic MEM_new PROTO( ( struct freelist_head * ) );
