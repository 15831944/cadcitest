...
extern STEPCODE_EXPRESS_EXPORT struct freelist_head STMT_fl;

extern STEPCODE_EXPRESS_EXPORT struct freelist_head ALIAS_fl;
extern STEPCODE_EXPRESS_EXPORT struct freelist_head ASSIGN_fl;
extern STEPCODE_EXPRESS_EXPORT struct freelist_head CASE_fl;
extern STEPCODE_EXPRESS_EXPORT struct freelist_head COMP_STMT_fl;
extern STEPCODE_EXPRESS_EXPORT struct freelist_head COND_fl;
extern STEPCODE_EXPRESS_EXPORT struct freelist_head LOOP_fl;
extern STEPCODE_EXPRESS_EXPORT struct freelist_head PCALL_fl;
extern STEPCODE_EXPRESS_EXPORT struct freelist_head RET_fl;
extern STEPCODE_EXPRESS_EXPORT struct freelist_head INCR_fl;

extern STEPCODE_EXPRESS_EXPORT Statement STATEMENT_ESCAPE;
extern STEPCODE_EXPRESS_EXPORT Statement STATEMENT_SKIP;
...
extern STEPCODE_EXPRESS_EXPORT Statement    STMTcreate PROTO( ( int ) );
extern STEPCODE_EXPRESS_EXPORT Statement    ALIAScreate PROTO( ( struct Scope_ *, Variable, Linked_List ) );
extern STEPCODE_EXPRESS_EXPORT Statement    CASEcreate PROTO( ( Expression , Linked_List ) );
extern STEPCODE_EXPRESS_EXPORT Statement    ASSIGNcreate PROTO( ( Expression , Expression ) );
extern STEPCODE_EXPRESS_EXPORT Statement    COMP_STMTcreate PROTO( ( Linked_List ) );
extern STEPCODE_EXPRESS_EXPORT Statement    CONDcreate PROTO( ( Expression, Linked_List, Linked_List ) );
extern STEPCODE_EXPRESS_EXPORT Statement    LOOPcreate PROTO( ( struct Scope_ *, Expression, Expression, Linked_List ) );
extern STEPCODE_EXPRESS_EXPORT Statement    PCALLcreate PROTO( ( Linked_List ) );
extern STEPCODE_EXPRESS_EXPORT Statement    RETcreate PROTO( ( Expression ) );
extern STEPCODE_EXPRESS_EXPORT void     STMTinitialize PROTO( ( void ) );
extern STEPCODE_EXPRESS_EXPORT struct Scope_ * INCR_CTLcreate PROTO( ( Symbol *, Expression start,
