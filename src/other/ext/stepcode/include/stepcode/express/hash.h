...
extern STEPCODE_EXPRESS_EXPORT struct freelist_head HASH_Table_fl;
extern STEPCODE_EXPRESS_EXPORT struct freelist_head HASH_Element_fl;
...
extern STEPCODE_EXPRESS_EXPORT void HASHinitialize PROTO( ( void ) );
extern STEPCODE_EXPRESS_EXPORT Hash_Table   HASHcreate PROTO( ( unsigned ) );
extern STEPCODE_EXPRESS_EXPORT Hash_Table   HASHcopy PROTO( ( Hash_Table ) );
extern STEPCODE_EXPRESS_EXPORT void HASHdestroy PROTO( ( Hash_Table ) );
extern STEPCODE_EXPRESS_EXPORT Element  HASHsearch PROTO( ( Hash_Table, Element, Action ) );
extern STEPCODE_EXPRESS_EXPORT void HASHlistinit PROTO( ( Hash_Table, HashEntry * ) );
extern STEPCODE_EXPRESS_EXPORT void HASHlistinit_by_type PROTO( ( Hash_Table, HashEntry *, char ) );
extern STEPCODE_EXPRESS_EXPORT Element  HASHlist PROTO( ( HashEntry * ) );
