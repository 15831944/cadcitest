...
extern STEPCODE_EXPRESS_EXPORT struct freelist_head ALG_fl;
extern STEPCODE_EXPRESS_EXPORT struct freelist_head FUNC_fl;
extern STEPCODE_EXPRESS_EXPORT struct freelist_head RULE_fl;
extern STEPCODE_EXPRESS_EXPORT struct freelist_head PROC_fl;
extern STEPCODE_EXPRESS_EXPORT struct freelist_head WHERE_fl;
...
extern STEPCODE_EXPRESS_EXPORT Scope    ALGcreate PROTO( ( char ) );
extern STEPCODE_EXPRESS_EXPORT void     ALGinitialize PROTO( ( void ) );
extern STEPCODE_EXPRESS_EXPORT void     ALGput_full_text PROTO( ( Scope, int, int ) );
