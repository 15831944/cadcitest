...
extern STEPCODE_EXPRESS_EXPORT struct EXPop_entry EXPop_table[OP_LAST];

extern STEPCODE_EXPRESS_EXPORT Expression  LITERAL_E;
extern STEPCODE_EXPRESS_EXPORT Expression  LITERAL_INFINITY;
extern STEPCODE_EXPRESS_EXPORT Expression  LITERAL_PI;
extern STEPCODE_EXPRESS_EXPORT Expression  LITERAL_ZERO;
extern STEPCODE_EXPRESS_EXPORT Expression  LITERAL_ONE;

extern STEPCODE_EXPRESS_EXPORT Error ERROR_bad_qualification;
extern STEPCODE_EXPRESS_EXPORT Error ERROR_integer_expression_expected;
extern STEPCODE_EXPRESS_EXPORT Error ERROR_implicit_downcast;
extern STEPCODE_EXPRESS_EXPORT Error ERROR_ambig_implicit_downcast;

extern STEPCODE_EXPRESS_EXPORT struct freelist_head EXP_fl;
extern STEPCODE_EXPRESS_EXPORT struct freelist_head OP_fl;
extern STEPCODE_EXPRESS_EXPORT struct freelist_head QUERY_fl;
extern STEPCODE_EXPRESS_EXPORT struct freelist_head QUAL_ATTR_fl;
...
extern STEPCODE_EXPRESS_EXPORT Expression   EXPcreate PROTO( ( Type ) );
extern STEPCODE_EXPRESS_EXPORT Expression   EXPcreate_simple PROTO( ( Type ) );
extern STEPCODE_EXPRESS_EXPORT Expression   EXPcreate_from_symbol PROTO( ( Type, Symbol * ) );
extern STEPCODE_EXPRESS_EXPORT Expression   UN_EXPcreate PROTO( ( Op_Code, Expression ) );
extern STEPCODE_EXPRESS_EXPORT Expression   BIN_EXPcreate PROTO( ( Op_Code, Expression, Expression ) );
extern STEPCODE_EXPRESS_EXPORT Expression   TERN_EXPcreate PROTO( ( Op_Code, Expression, Expression, Expression ) );
extern STEPCODE_EXPRESS_EXPORT Expression   QUERYcreate PROTO( ( Symbol *, Expression ) );
extern STEPCODE_EXPRESS_EXPORT void     EXPinitialize PROTO( ( void ) );
extern STEPCODE_EXPRESS_EXPORT void     EXPcleanup PROTO( ( void ) );
extern STEPCODE_EXPRESS_EXPORT Type     EXPtype PROTO( ( Expression, struct Scope_ * ) );
extern STEPCODE_EXPRESS_EXPORT int      EXPget_integer_value PROTO( ( Expression ) );
