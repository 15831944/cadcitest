...
extern STEPCODE_EXPRESS_EXPORT char DICT_type;  /**< set as a side-effect of DICT lookup routines to type of object found */
...
extern STEPCODE_EXPRESS_EXPORT void     DICTinitialize PROTO( ( void ) );
extern STEPCODE_EXPRESS_EXPORT void     DICTcleanup PROTO( ( void ) );
extern STEPCODE_EXPRESS_EXPORT int      DICTdefine PROTO( ( Dictionary, char *, Generic, Symbol *, char ) );
extern STEPCODE_EXPRESS_EXPORT int      DICT_define PROTO( ( Dictionary, char *, Generic, Symbol *, char ) );
extern STEPCODE_EXPRESS_EXPORT void     DICTundefine PROTO( ( Dictionary, char * ) );
extern STEPCODE_EXPRESS_EXPORT Generic      DICTlookup PROTO( ( Dictionary, char * ) );
extern STEPCODE_EXPRESS_EXPORT Generic      DICTlookup_symbol PROTO( ( Dictionary, char *, Symbol ** ) );
extern STEPCODE_EXPRESS_EXPORT Generic      DICTdo PROTO( ( DictionaryEntry * ) );
extern STEPCODE_EXPRESS_EXPORT void     DICTprint PROTO( ( Dictionary ) );
