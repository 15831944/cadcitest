...
extern STEPCODE_EXPRESS_EXPORT struct freelist_head VAR_fl;
...
extern STEPCODE_EXPRESS_EXPORT Variable VARcreate PROTO( ( Expression, Type ) );
extern STEPCODE_EXPRESS_EXPORT void VARinitialize PROTO( ( void ) );
extern STEPCODE_EXPRESS_EXPORT char * VARget_simple_name PROTO( ( Variable ) );
