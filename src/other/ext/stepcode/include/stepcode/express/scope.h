...
extern STEPCODE_EXPRESS_EXPORT struct Symbol_ * SCOPE_get_symbol PROTO( ( Generic ) );
extern STEPCODE_EXPRESS_EXPORT void     SCOPE_get_entities PROTO( ( Scope, Linked_List ) );
extern STEPCODE_EXPRESS_EXPORT Linked_List  SCOPEget_entities PROTO( ( Scope ) );
extern STEPCODE_EXPRESS_EXPORT Linked_List  SCOPEget_entities_superclass_order PROTO( ( Scope ) );
extern STEPCODE_EXPRESS_EXPORT Generic      SCOPEfind PROTO( ( Scope, char *, int ) );
extern STEPCODE_EXPRESS_EXPORT void     SCOPE_get_functions PROTO( ( Scope, Linked_List ) );
extern STEPCODE_EXPRESS_EXPORT Linked_List  SCOPEget_functions PROTO( ( Scope ) );
extern STEPCODE_EXPRESS_EXPORT void     SCOPE_get_rules PROTO( ( Scope, Linked_List ) );
extern STEPCODE_EXPRESS_EXPORT Linked_List  SCOPEget_rules PROTO( ( Scope ) );
