...
extern STEPCODE_EXPRESS_EXPORT struct Object * OBJ;
...
extern STEPCODE_EXPRESS_EXPORT void OBJinitialize PROTO( ( void ) );
extern STEPCODE_EXPRESS_EXPORT void OBJcleanup PROTO( ( void ) );
extern STEPCODE_EXPRESS_EXPORT void OBJcreate PROTO( ( char, struct Symbol_ * ( * )( Generic ), char *, int ) );
extern STEPCODE_EXPRESS_EXPORT Symbol * UNK_get_symbol PROTO( ( Generic x ) );
