...
extern STEPCODE_EXPRESS_EXPORT struct freelist_head CASE_IT_fl;
...
extern STEPCODE_EXPRESS_EXPORT Case_Item    CASE_ITcreate PROTO( ( Linked_List, struct Statement_ * ) );
extern STEPCODE_EXPRESS_EXPORT void     CASE_ITinitialize PROTO( ( void ) );
