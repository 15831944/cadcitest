...
extern STEPCODE_EXPRESS_EXPORT struct freelist_head REN_fl;
extern STEPCODE_EXPRESS_EXPORT struct freelist_head SCOPE_fl;
extern STEPCODE_EXPRESS_EXPORT struct freelist_head SCHEMA_fl;

extern STEPCODE_EXPRESS_EXPORT int __SCOPE_search_id;
...
extern STEPCODE_EXPRESS_EXPORT Variable VARfind PROTO( ( Scope, char *, int ) );
extern STEPCODE_EXPRESS_EXPORT Schema   SCHEMAcreate PROTO( ( void ) );
extern STEPCODE_EXPRESS_EXPORT void     SCHEMAinitialize PROTO( ( void ) );
extern STEPCODE_EXPRESS_EXPORT void     SCHEMAadd_use PROTO( ( Schema, Symbol *, Symbol *, Symbol * ) );
extern STEPCODE_EXPRESS_EXPORT void     SCHEMAadd_reference PROTO( ( Schema, Symbol *, Symbol *, Symbol * ) );
extern STEPCODE_EXPRESS_EXPORT void     SCHEMAdefine_use PROTO( ( Schema, Rename * ) );
extern STEPCODE_EXPRESS_EXPORT void     SCHEMAdefine_reference PROTO( ( Schema, Rename * ) );
extern STEPCODE_EXPRESS_EXPORT Generic  SCHEMAfind PROTO( ( Schema, char * name, int search_refs ) );
extern STEPCODE_EXPRESS_EXPORT Scope    SCOPEcreate PROTO( ( char ) );
extern STEPCODE_EXPRESS_EXPORT Scope    SCOPEcreate_tiny PROTO( ( char ) );
extern STEPCODE_EXPRESS_EXPORT Scope    SCOPEcreate_nostab PROTO( ( char ) );
extern STEPCODE_EXPRESS_EXPORT void     SCOPEdestroy PROTO( ( Scope ) );
extern STEPCODE_EXPRESS_EXPORT Linked_List SCHEMAget_entities_use PROTO( ( Scope ) );
extern STEPCODE_EXPRESS_EXPORT Linked_List SCHEMAget_entities_ref PROTO( ( Scope ) );
