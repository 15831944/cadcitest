...
extern STEPCODE_EXPRESS_EXPORT struct freelist_head SYMBOL_fl;
...
extern STEPCODE_EXPRESS_EXPORT void SYMBOLinitialize PROTO( ( void ) );
STEPCODE_EXPRESS_EXPORT Symbol * SYMBOLcreate( char * name, int line, char * filename );
